...
+-------------+-------------------+----------------------+-----------------------------------+-------------------+------------------------+
| Name        | Flag              | ``stdin``-compatible | space complexity                  | fixed sample size | fractional sample size |
+-------------+-------------------+----------------------+-----------------------------------+-------------------+------------------------+
| Reservorir  | ``--reservoir``   | yes                  | O(sample_size * max(record_size)) | compatible        | not compatible         |
| Approximate | ``--approximate`` | yes                  | O(1)                              | not compatible    | compatible             |
| Two-pass    | ``--two-pass``    | no                   | O(sample_size)                    | compatible        | compatible             |
+-------------+-------------------+----------------------+-----------------------------------+-------------------+------------------------+
